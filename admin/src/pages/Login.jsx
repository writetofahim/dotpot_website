      ...
      <section className="flex items-center justify-center">
        <div className="container min-h-[100vh] flex items-center justify-center p-5">
          <form onSubmit={handleSubmit} className="w-full max-w-md p-5 border rounded-xl shadow-xl glassmorphism">
            ...
            <h1 className="text-center text-6xl text-blue-500 font-bold">SIGN IN</h1>
            ...
            <div className="relative flex items-center mt-8">
              ...
              <input type="email" name='email' className="block w-full py-3 text-gray-700 bg-white border rounded-lg px-11 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40 focus:ring-primary-300" placeholder="Email address" required />
            </div>
