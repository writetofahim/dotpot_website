        ...
        <div className="flex flex-col pt-12 lg:text-justify">
          ...
          <div className="my-12 lg:mx-24 mx-6">
            <h2 className="lg:text-2xl text-xl font-bold mb-4">
              Hire Dedicated Partnership Model
            </h2>
            <p className="text-lg">
              Dotpot iT is a rapidly growing technology company that offers a
              wide range of IT services, including software development, mobile
              app development, web development, and digital marketing. To keep
              up with the demand for its services, the company needs a team of
              skilled professionals who can work together to deliver
              high-quality solutions to its clients. This is where hiring a
              dedicated model comes in.
            </p>
            <p className="text-lg py-2">
              A dedicated model is a hiring strategy where a company hires a
            ...
            <div className="my-6">
              <h2 className="lg:text-2xl text-xl font-semibold mb-4">
                Benefits of hiring a dedicated partnership model for Dotpot iT:
              </h2>
              <ul className="list-disc list-inside">
                <li className="mb-2 text-lg">
                  ...
                  When you hire a dedicated model, you get access to a team of
                  skilled professionals who have experience working in your
                  industry. This means that they can quickly understand your
                  requirements and deliver solutions that meet your needs.
                </li>
                <li className="mb-2 text-lg">
                  <strong className="font-semibold">Cost-effective:</strong>{" "}
                  Hiring a dedicated model can be more cost-effective than
                ...
                <li className="mb-2 text-lg">
                  <strong className="font-semibold">Scalability:</strong> With a
                ...
                <li className="mb-2 text-lg">
                  <strong className="font-semibold">Flexibility:</strong> A
                ...
                <li className="mb-2 text-lg">
                  <strong className="font-semibold">Control:</strong> When you
                  hire a dedicated model, you have complete control over the
                  team's work. You can monitor their progress, provide feedback,
                  and make changes as needed.
                </li>
              </ul>
            </div>
            <p className="text-lg">
              In conclusion, hiring a dedicated model is a great option for
