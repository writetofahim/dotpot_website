...
{/* <div className="container mx-auto">
      ...
      <section className="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8">
        ...
        <h1 className="text-4xl md:text-6xl text-primary-500 font-extrabold py-4">Hire Dedicated Partnership Model</h1>
          <div className="w-full">
            <img className="max-w-full h-auto" src="https://web-peppers.com/wp-content/uploads/2020/02/How-to-Hire-the-Best-Dedicated-Development-Team.jpg" alt="Product image" />
          </div>
          <div className="my-12 mx-24">
            ...
            <div className="bg-white rounded-lg shadow p-6 my-6">
              <h2 className="text-2xl font-bold mb-4">Benefits of hiring a dedicated model for Dotpot iT</h2>
              <ul className="list-disc list-inside">
                <li className="mb-2">
                  <strong className="font-bold">Access to skilled professionals:</strong> When you hire a dedicated model, you get access to a team of skilled professionals who have experience working in your industry. This means that they can quickly understand your requirements and deliver solutions that meet your needs.
                </li>
                <li className="mb-2">
                  <strong className="font-bold">Cost-effective:</strong> Hiring a dedicated model can be more cost-effective than hiring a team of full-time employees. This is because you do not have to pay for benefits, office space, or hardware. Instead, you pay a fixed monthly fee for the team's services.
                </li>
                <li className="mb-2">
                  <strong className="font-bold">Scalability:</strong> With a dedicated model, you can easily scale up or down your team size based on your project requirements. This means that you can quickly respond to changes in demand without having to worry about hiring or firing employees.
                </li>
                <li className="mb-2">
                  <strong className="font-bold">Flexibility:</strong> A dedicated model gives you the flexibility to work with a team of professionals who are located in different time zones. This means that you can extend your working hours and deliver projects faster.
                </li>
                <li>
                  <strong className="font-bold">Control:</strong> When you hire a dedicated model, you have complete control over the team's work. You can monitor their progress, provide feedback, and make changes as needed.
                </li>
              </ul>
            </div>
            <p className="text-xl">
