...
const Faq = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Our pricing is based on factors such as project complexity, scope, and timeline. We provide customized quotes tailored to each client's specific requirements. Please reach out to us to discuss your project and get a detailed quote."
    },
    {
      id: 7,
      question: "Can you work with our existing IT infrastructure and systems?",
      answer: "Yes, we can seamlessly integrate with your existing IT infrastructure and systems. Our team has experience working with a variety of technologies and platforms, allowing us to adapt to your environment."
    },
    {
      id: 8,
      question: "How do you handle project communication and updates?",
      answer: "We maintain open and transparent communication throughout the project. We provide regular updates, progress reports, and schedule meetings to discuss project status, address any concerns, and ensure alignment with your requirements."
    },
    {
      id: 9,
      question: "What is your project development process?",
      answer: "We follow an agile project development methodology that emphasizes collaboration, flexibility, and iterative development. Our process includes requirements gathering, design, development, testing, deployment, and ongoing support."
    },
    {
      id: 10,
      question: "How do you ensure the security of our data and sensitive information?",
      answer: "We prioritize data security and follow industry best practices to protect your sensitive information. We implement robust security measures, including data encryption, access controls, and regular security audits."
    },
  ];
        ...
        <div className="flex flex-col py-10 w-3/4 ">
          {faqs.map((faq) => (
            ...
            >
              ...
              >
                <button className="text-base font-bold text-buttonText-500 lg:text-xl">{faq.question}</button>
                <BsPlusLg />
              </div>
              <div
