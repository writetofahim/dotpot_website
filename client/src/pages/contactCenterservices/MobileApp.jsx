...
<div>
  ...
  <div className='px-3 min-h-screen pt-[15vh]'>
    <div className='container mx-auto'>
      <h1 className='text-3xl md:text-5xl font-extrabold mb-2 md:mb-5 block text-primary-500 text-center'>Mobile App
        Module
      </h1>
      <div className='text-gray-400 flex flex-col gap-5 p-5'>
        <p className='text-justify'>
          Dotpot IT's contact center system enables contact center agents to be mobile through the use of a mobile
          application. This feature is particularly useful for enterprise customers as it provides them with access to
          customized services. With our mobile apps, agents can easily access the features they need to serve customers
          efficiently.
        </p>
      </div>
      <div className="border-b container mx-auto">
        <img className="md:w-1/6 md:h-50 mx-auto mb-6" src={ma} alt="Customer service" />
      </div>
