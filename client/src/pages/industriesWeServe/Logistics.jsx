          ...
          <div className="py-12 lg:mx-24 mx-6">
            ...
            <div className="text-textColor-500 flex flex-col gap-5 py-2 lg:px-5 text-justify">
              <p>
                ...
                search engines. We also offer logistics and distribution website
                development services that help businesses in this industry
                streamline their operations and improve their supply chain
                management.
              </p>
              ...
              <p>
                ...
                shipping and delivery options, and inventory management to improve
                visibility and optimize processes. This ensures that our clients
                can efficiently track shipments and manage their inventory, saving
                them time and money.
              </p>
              ...
              <p>
                ...
                Logistics & Distribution industry can improve their operations,
                enhance user experience, and increase customer engagement, leading
                to improved business growth and revenue.
              </p>
              <p>
                ...
                approach. Our customized web solutions, logistics and distribution
                website development services, and expert support help businesses
                achieve their goals and optimize their supply chain management
                with ease.
              </p>
            </div>
            <div className="pt-6">
              ...
              <ul className="list-disc list-inside">
                ...
                <li className="text-textColor-500 mb-2 lg:px-10 px-3">
                  ...
                  <p className="px-2">
                    ...
                    devices, ensuring that users can access them from any device,
