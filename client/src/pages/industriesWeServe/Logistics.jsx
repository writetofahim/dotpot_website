  ...
  const worksData = [
    {
      ...
      description: `Implement a robust shipment tracking system that allows customers to track the status and location of their packages in real-time. Provide automated notifications and updates throughout the shipping process.`,
    ...
    },
    {
      ...
      description: `Incorporate <a href="https://optimoroute.com/what-is-route-optimization/" target="_blank" rel="nofollow">route optimization  </a>capabilities to help logistics companies streamline their delivery processes. Utilize algorithms to calculate the most efficient routes, reducing fuel consumption, and delivery time.`,
      illustration: blogweb,
    },
    {
      id: 5,
                      ...
                      <div className="flex flex-col-reverse md:flex-col-reverse lg:flex-row items-center justify-center">
                        <div className="text-center md:text-center lg:text-left w-full md:w-1/2 lg:w-1/2 px-3 pb-10 ">
                          ...
                          <p className="text-center md:text-center lg:text-left text-xs md:text-base text-gray-400 mt-2">
                            Revolutionize your{" "}
                            <a
                              href="https://www.crownsds.com/whats-the-difference-between-logistics-and-distribution/"
                              target="_blank"
                              rel="nofollow"
                            >
                              logistics & distribution
                            </a>{" "}
                            business with Dotpot IT's customized web solutions.
                            Streamline operations for optimal efficiency and
                            exponential growth.
                          </p>
                        </div>
                        <img
                ...
                <>
                  ...
                  >
                    ...
                    <p className="md:w-2/5 w-full mx-auto text-center my-5 text-gray-400">
                      Dotpot IT is the preferred partner for logistics and
                      distribution businesses seeking top-notch web design and
                      development solutions. With their extensive expertise in
                      the field, they craft visually appealing and user-friendly
                      websites that cater specifically to the needs of this
                      industry. Dotpot IT offers a range of tailored services,
                      including inventory management systems, order tracking
                      functionalities, warehouse management portals, and more.
                      They prioritize seamless user experiences and provide
                      ongoing maintenance and support to ensure optimal website
                      performance. Dotpot IT assists logistics and distribution
                      companies in enhancing their online presence and
                      delivering exceptional digital experiences in this
