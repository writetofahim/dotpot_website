...
export const processWeFollowData = [
  ...
  },
  {
    id: 2,
    title: "UI/UX Design",
    desc: "We create catchy and charming designs with the latest tools of designing to make it a best user-friendly experience.",
  },
  {
    id: 3,
    title: "Prototype",
    desc: "After designing, you will get your prototype, which will be sent ahead for the development process for the product.",
  },
  {
    id: 4,
    title: "Development",
    desc: "Development of mobile application/web/blockchain started using latest tools and technologies with transparency.",
  },
  {
    id: 5,
    title: "Quality Assurance",
    desc: "Hyperlink values quality and provides 100% bug free application with no compromisation in it.",
  },
  {
    id: 6,
    title: "Deployment",
    desc: "After trial and following all processes, your app is ready to launch on the App store or Play Store.",
  },
  {
    id: 7,
...
export const blogData = [
  ...
  },
  {
    id: 3,
    title:
      "Why Unity 3D is still the preferred game engine for many developers?",
