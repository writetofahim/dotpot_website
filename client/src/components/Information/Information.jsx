        ...
        <div className='py-10 md:p-5 bg-primary-100 w-full flex justify-center items-center'>
            <div className="w-full md:max-w[1400px] lg:max-w-[1400px] p-3 md:p-10 md:px-5 lg:px-0 flex flex-col items-center justify-between md:flex-col lg:flex-row gap-5">
                <div className="left flex-[2] h-full">
                    ...
                    {
                        !isOpen ? 
                            <button onClick={()=>setIsOpen(!isOpen)} className="mt-2 flex items-center gap-2 font-bold text-primary-400 hover:text-secondary-500 cursor-pointer">Read More <BsChevronDoubleDown /></button> 
                        : 
                            <button onClick={()=>setIsOpen(!isOpen)} className="mt-2 flex items-center gap-2 font-bold text-primary-400 hover:text-secondary-500 cursor-pointer">Read Less <BsChevronDoubleDown className='rotate-180' /></button>
                    }
                </div>
