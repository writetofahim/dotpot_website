...
const Card = ({ id, icon, number, text }) => {
  return (
    <div
      className={`flex flex-col items-stretch justify-center p-10 shadow rounded h-[350px] w-[100%] md:w-[30%] md:min-w-[200px] ${
        id === 2 || id === 5 ? "md:mt-10 lg:mt-10" : ""
      }`}
    >
      <div className="flex flex-col gap-5 items-center justify-center">
        <img
          ...
          alt="Information about Dotpot iT"
        />
        <p className="text-4xl font-extrabold text-textColor-500">{number}+</p>
        <p className="">{text}</p>
      </div>
    </div>
  );
