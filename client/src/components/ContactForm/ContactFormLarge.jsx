...
const ContactFormLarge = () => {
    ...
    return (
        <div className="shadow w-full p-5 rounded-xl max-w-[1200px] bg-background-500 border border-b border-border">
            ...
            <form onSubmit={handleSubmit}>
                <div className="w-full flex flex-col md:flex-row items-center md:gap-5">
                    <div className="border-b border-border w-full flex items-center mt-5">
                        ...
                        <input type="text" placeholder="Your Full Name*" name="name" className="w-full p-2 text-gray-400  bg-background-500 outline-none" required />
                    </div>
                    <div className="border-b border-border w-full flex items-center mt-5">
                        <MdMail className='text-textColor-500 text-2xl' />
                        <input type="email" name='email' placeholder="Your Email*" className="w-full p-2 text-gray-400  bg-background-500 outline-none" required />
                    </div>
                </div>
                <div className="w-full flex flex-col md:flex-row items-center md:gap-5">
                    <div className="border-b border-border w-full flex items-center mt-5">
                        <MdPhone className='text-textColor-500 text-2xl' />
                        <input name='phone' type="text" placeholder="Contact Number*" className="w-full p-2 text-gray-400  bg-background-500 outline-none" required />
                    </div>
                    <div className="border-b border-border w-full flex items-center mt-5">
                        <RiWhatsappFill className='text-textColor-500 text-2xl' />
                        <input name="whatsapp" type="text" placeholder="Whatsapp Number" className="w-full p-2 text-gray-400  bg-background-500 outline-none" required />
                    </div>
                    <div className="border-b border-border w-full flex items-center mt-5">
                        <BsSkype className='text-textColor-500 text-2xl' />
                        <input name='skype' type="text" placeholder="Skype" className="w-full p-2 text-gray-400  bg-background-500 outline-none" required />
                    </div>
                </div>
                <div className="border-b border-border w-full flex items-center mt-5">
                    <input onChange={(e) => setFiles(e.target.files)} type="file" placeholder="Choose a file" name="files" className="w-full p-2 text-gray-400  bg-background-500 outline-none " />
                </div>
                <div className="border-b border-border w-full flex items-center mt-5 ">
                ...
                <div className="border-b border-border w-full flex items-start mt-5 mb-10">
                    ...
                    <textarea name="message" type="text" placeholder="Your Message*" rows="5" className="w-full p-2 text-gray-400  bg-background-500 outline-none">
                    </textarea>
                </div>
