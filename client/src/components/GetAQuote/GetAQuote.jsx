        ...
        <div className="left w-full">
          {/* <Typed
                className="text-xl md:text-3xl font-bold"
                    ...
                    loop
                /> */}
          <h3 className="text-xl text-textColor-500 md:text-3xl text-center md:text-left font-bold mb-2 backdrop-blur-sm md:w-max">
            Customize Your Service
          </h3>
          <p className="text-center md:text-left backdrop-blur-sm md:w-max text-textColor-500">
