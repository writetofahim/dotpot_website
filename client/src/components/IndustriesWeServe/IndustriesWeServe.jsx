...
export const ProcessCard = (props) => {
  return (
    <Link
      to={props.link}
      className="bg-bgSecondary-200 rounded-lg flex flex-col items-stretch justify-between md:justify-center p-3 md:p-10 shadow h-[150px] md:h-[200px] w-[45%] md:w-[18%] md:min-w-[200px] hover:scale-110 transition-all cursor-pointer"
    >
      <div>
        <div className="flex flex-col gap-5 items-center justify-center">
          ...
          />
          <p className="text-md md:text-xl font-bold text-center text-secondary-500">
            {props.title}
          </p>
        </div>
      </div>
...
const IndustriesWeServe = () => {
  ...
  return (
    <div className="industriesWeServe w-full overflow-hidden py-10 md:flex md:flex-col md:justify-center bg-bgSecondary-500">
      <div className="p-5 mt-5 w-full md:max-w-[1400px] self-center flex gap-5 flex-wrap items-center justify-center">
        <h1 className="mt-10 text-3xl md:text-5xl text-center font-bold w-full mb-5 text-primary-500">
          Industries We Serve
        </h1>
        {data &&
          data.map((item, index) => {
