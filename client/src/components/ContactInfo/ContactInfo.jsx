  ...
  return (
    <section className="text-gray-600 body-font mt-10">
      ...
      <div className="container px-5 py-24 mx-auto flex flex-col-reverse md:flex-row flex-wrap gap-10 md:gap-0">
        <div className="lg:w-1/2 w-full mb-10 lg:mb-0 rounded-lg overflow-hidden bg-bgSecondary-500">
          {/* <iframe
        ...
        {data && (
          <div className="flex flex-col justify-center items-center flex-wrap lg:py-6 -mb-10 lg:w-1/2 lg:pl-12 lg:text-left text-center ">
            <div className="flex flex-col mb-10 lg:items-start items-center w-4/5 p-5 border border-border rounded-xl shadow-xl bg-bgSecondary-500">
              <div className="w-12 h-12 inline-flex items-center justify-center rounded-full bg-bgSecondary-100 hover:bg-bgSecondary-300 hover:scale-110 transition-all text-xl hover:text-white">
                <BsTelephone />
              </div>
              <div className="flex-grow">
                <h2 className="text-lg title-font font-medium mb-3 text-primary-500">
                  Call Us On
                </h2>
                {data &&
                  data.phone.map((item, index) => (
                    <p className="leading-relaxed text-base text-secondary-500" key={index}>
                      {item}
                    </p>
                  ))}
              </div>
            ...
            <div className="flex flex-col mb-10 lg:items-start items-center w-4/5 p-5 border border-border rounded-xl shadow-xl bg-bgSecondary-500">
              ...
              <div className="flex-grow">
                <h2 className="text-primary-500 text-lg title-font font-medium mb-3">
                  Send Email
                </h2>
                {data &&
            ...
            <div className="flex flex-col mb-10 lg:items-start items-center w-4/5 p-5 border border-border rounded-xl shadow-xl bg-bgSecondary-500">
              ...
              <div className="flex-grow">
                ...
                <p className="text-secondary-500">Dotpot iT</p>
                <p className="text-secondary-500">House-1, Road-3, Block-A</p>
                <p className="text-secondary-500">Mirpur-10, Dhaka, Bangladesh</p>
              </div>
            </div>
          </div>
        )}
