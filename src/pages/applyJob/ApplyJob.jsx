...
export const JobCard = (props) => {
    return (
        <Link to="./#jobDetails">
            <div className="job-card w-full p-5 border rounded-xl hover:border-primary-500 text-gray-400 gap-1" onClick={()=>props.setId(props.id)}>
    ...
    return (
        <div className='w-screen flex items-center justify-center' >
            <div className="w-full max-w-[1400px] container pt-20 pb-20 px-5">
                {/* <h1 className="text-center text-4xl text-primary-500 font-bold mb-5">{jobPageData.title}</h1>
                <p className='md:w-1/2 p-5 text-center m-auto mb-10'>
                    {jobPageData.desc}
                </p> */}
