...
export const ProcessCard = (props) => {
    return(
        <div className="bg-white rounded-lg flex flex-col items-stretch justify-center p-10 shadow h-[350px] w-[100%] md:w-[20%] md:min-w-[200px]">
...
const ProcessWeFollow = () => {
    return (
        <div className='w-full overflow-hidden py-10 md:flex md:flex-col md:justify-center bg-primary-100'>
            ...
            <h1 className="mt-10 text-6xl font-bold w-full text-primary-500 mb-5 ">Process We Follow</h1>
                {
