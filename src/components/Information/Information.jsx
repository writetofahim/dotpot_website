...
const Information = () => {
    return (
        <div className='bg-white w-full flex justify-center'>
            <div className="w-full md:max-w[1400px] lg:max-w-[1400px] p-10 md:px-5 lg:px-0 flex flex-col md:flex-row lg:flex-row gap-5">
                <div className="left flex-[2]">
                    <h1 className="text-4xl text-primary-500 font-bold mb-5 lg:mt-10 md:mt-10">DotporiT</h1>
